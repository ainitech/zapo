...
| [`@zapo-js/baileys-connector`](packages/baileys-connector) | `@zapo-js/store-sqlite` (optional) | Drop-in `@whiskeysockets/baileys` API surface backed by zapo-js, for migrating an existing Baileys app without rewriting it.                     |
